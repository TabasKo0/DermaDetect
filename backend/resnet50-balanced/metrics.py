...
# ==== CONFIG (Balanced Model) ====
MODEL_PATH = 'best_skin_cancer_resnet50.pt'  # Updated path for balanced model
...
OUTPUT_DIR = 'website_metrics_logs_balanced'
...
def main():
    ...
    # Use the same validation split as training for fair metrics
